...
namespace LocadorafilmesMVC.Controllers
{
    public class LocacoesController : Controller
    {
        ...
        public LocacoesController(LocadorafilmesMVCContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,DataLocacao,DataDevolucao")] Locacao locacao)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,DataLocacao,DataDevolucao")] Locacao locacao)
        {
            if (id != locacao.Id)
            {
                return NotFound();
